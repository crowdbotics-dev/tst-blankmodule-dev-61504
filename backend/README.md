...
## Project Structure
    ...
    ├── tst_blankmodule_dev_61504  # Django project configurations
...
1. Clone this repo and `cd tst_blankmodule_dev_61504`
...
2. Clone this repo and `cd tst_blankmodule_dev_61504`
